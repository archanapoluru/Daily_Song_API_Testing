...
public class DELaPlaylist {
	...
	private TestBase responsebody;
	 ...
	 @Given("^Header is accepted for DELETE$")
	    public void header_is_accepted_for_delete() throws Throwable {
	        System.out.println("Header is accepted");
	    }

	    @When("^Delete request is made with the Playlist ID \"([^\"]*)\"$")
	    public void delete_request_is_made_with_the_playlist_id_something(String Url) throws Throwable {
	        responsebody.Deletemethod(Url);
	    }

	    @Then("^Expected response code for this is 204$")
	    public void expected_response_code_for_this_is_204() throws Throwable {
	    ...
	    public void expected_response_body_has_something(String strArg1) throws Throwable {
